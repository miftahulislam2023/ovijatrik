            ...
            <CardContent>
                <form action={createAction} className="space-y-4">
                    <div className="grid gap-4 md:grid-cols-2">
                        ...
                        <input name="targetAmount" type="number" min={1} placeholder="Target amount" className="rounded-md border border-input px-3 py-2" required />
                        <select name="status" className="rounded-md border border-input px-3 py-2">
                            <option value="DRAFT">DRAFT</option>
                            <option value="PUBLISHED">PUBLISHED</option>
                            <option value="ARCHIVED">ARCHIVED</option>
                        </select>
                        <div className="grid gap-2 md:grid-cols-2">
                            <input name="startDate" type="date" className="rounded-md border border-input px-3 py-2" />
                            <input name="endDate" type="date" className="rounded-md border border-input px-3 py-2" />
                        </div>
                    </div>
                    <textarea name="descriptionBn" placeholder="Description (Bangla)" rows={6} className="w-full rounded-md border border-input px-3 py-2" required />
                    <textarea name="descriptionEn" placeholder="Description (English)" rows={6} className="w-full rounded-md border border-input px-3 py-2" />
                    <textarea
                        name="photoUrls"
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <Link href="/admin/weekly-projects" className="text-sm text-primary underline">Cancel</Link>
                    </div>
                </form>
            </CardContent>
        </Card>
