        ...
        <Card>
            ...
            <CardContent className="space-y-4 text-sm text-muted-foreground">
                ...
                <div className="flex gap-3">
                    {!message.readAt && (
                        <form action={markReadAction}><Button type="submit" variant="outline">Mark as Read</Button></form>
                    )}
                    <form action={deleteAction}><Button type="submit" variant="destructive">Archive Message</Button></form>
                </div>
            </CardContent>
        </Card>
    );
