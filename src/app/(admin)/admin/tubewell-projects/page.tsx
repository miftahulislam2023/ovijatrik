...
import { duplicateTubewellProject, softDeleteTubewellProject } from "@/actions/tubewell-project";
    ...
    return (
        <div className="space-y-6">
            ...
            <form className="grid gap-3 rounded-lg border border-border p-3 md:grid-cols-[1fr_180px_auto]" method="get">
                <input name="q" defaultValue={q} placeholder="Search title, slug, location" className="rounded-md border border-input px-3 py-2" />
                <select name="year" defaultValue={params.year || ""} className="rounded-md border border-input px-3 py-2">
