            ...
            <div className="flex min-h-screen">
                <aside className="w-64 shrink-0 border-r border-black/10 bg-white px-6 py-8 dark:border-white/10 dark:bg-[#0b1012]">
                    <div className="space-y-8">
                        <div>
                            <p className="text-xs uppercase tracking-[0.25em] text-slate-400 dark:text-white/40">{content.admin}</p>
                            <h1 className="text-xl font-semibold">Ovijatrik</h1>
                        </div>
                    ...
                    <header className="border-b border-black/10 px-8 py-6 dark:border-white/10">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-sm text-slate-500 dark:text-white/50">{content.subtitle}</p>
                            </div>
