    ...
    return (
        <main className="min-h-screen bg-background text-foreground">
            <section className="mx-auto max-w-4xl px-4 py-12">
                ...
                <p className="mt-1 text-xs text-muted-foreground">সম্পন্নের বছর: {project.year}</p>

                <p className="mt-6 text-sm leading-relaxed text-muted-foreground">{project.descriptionBn}</p>
