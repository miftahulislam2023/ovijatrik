        ...
        <header className="sticky top-0 z-40 border-b border-black/5 bg-white/90 backdrop-blur dark:border-white/10 dark:bg-[#0f1416]/90">
            <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-4">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <p className="text-sm uppercase tracking-[0.2em] text-primary-dark">{content.name}</p>
                        <p className="text-xs text-muted-foreground dark:text-white/60">{content.tagline}</p>
                    </div>
                </div>
                ...
                <div className="flex items-center gap-2">
                    <LanguageToggle />
                    <ThemeToggle />
                    <Button asChild variant="outline" className="hidden border-primary-dark text-primary-dark lg:inline-flex">
                        <Link href="/join-us">{content.join}</Link>
                    </Button>
                    <Button asChild className="bg-primary-dark text-white hover:bg-primary-brand">
